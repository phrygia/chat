...
import { loginUser, logoutUser, loadStatusMessage, loadStatusName, loadAllFriendsList } from './redux/_actions/user_action'
...
import MainPanel from './components/chat/main/MainPanel'
  ...
  */
  ...
  useEffect(() => {
    ...
    firebase.auth().onAuthStateChanged((user) => {
      // 로그인된 상태
      if (user) {
        if (nowHistoryPath === '/login' || nowHistoryPath === '/register' || nowHistoryPath === '/edit/password') {
          history.push('/')
        }
        ...
        <>
          ...
          <div className={sideShow ? 'layout_content' : 'user_content'}>
            <Switch>
              ...
              <Route path="/chat/:id" exact component={MainPanel} />
